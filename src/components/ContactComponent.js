...
import {BreadcrumbItem, Breadcrumb, FormGroup, Form, Button, Label, Input, Col, FormFeedback} from 'reactstrap';
     ...
     validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.lastname && lastname.length < 3)
         ...
         if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel. Numer should contain only numbers'
